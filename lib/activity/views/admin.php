...
<div class="activity-tabs wrapper">
    ...
    <div class="option">
    	<span><?php _e( 'Show', TRANSLATION_KEY ); ?></span>
		...
		<span><?php _e( 'recent posts', TRANSLATION_KEY ); ?></span>
    </div>
    ...
    <div class="option">
    	...
    	<span><?php _e( 'most commented posts', TRANSLATION_KEY ); ?></span>
    </div>
    ...
    <div class="option">
		...
		<span><?php _e( 'recent comments', TRANSLATION_KEY ); ?></span>
    </div>
	 ...
	 <div class="option">
		...
		<span><?php _e( 'most used tags', TRANSLATION_KEY ); ?></span>
    </div>
