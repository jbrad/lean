...
class Google_Custom_Search extends WP_Widget {
	...
	public function existing_search_results_template() {
		...
		} else if( 'page' == get_current_screen()->id && 1 == get_post_meta( $page_id, 'standard_google_custom_search', true ) ) {
		
				echo '<div id="standard-gcse-template-notification" class="updated"><p>' . __( 'This page was generated by Standard for use with the Google Custom Search widget. Remove the widget from all sidebar to delete this page.', 'standard') . '</p></div>';	
