...
class Google_Custom_Search extends WP_Widget {
	...
	function __construct() {
		...
		$widget_opts = array(
			'classname' 	=> __( 'google-custom-search', 'lean' ),
			'description' 	=> __( 'Easily add Google Custom Search to your Lean-powered blog.', 'lean' )
		);
		$this->WP_Widget( 'google-custom-search', __( 'Google Custom Search', 'lean' ), $widget_opts );
	...
	public function existing_search_results_template() {
		...
		// Otherwise, if we're editing the generated Search Results page, then we need to display a message.
			...
			// Otherwise, they are on the post edit page so they should be able to see the message.
				...
				echo '<div id="gcse-template-notification" class="updated"><p>' . __( 'This page was generated by Lean for use with the Google Custom Search widget. <a href="widgets.php">Remove the widget</a> from all sidebars to delete this page.', 'lean' ) . '</p></div>';
