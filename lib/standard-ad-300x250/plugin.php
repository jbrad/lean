...
class Standard_Ad_300x250 extends WP_Widget {
	...
	public function register_admin_scripts() {
		...
		if( 'widgets' == $screen->id ) {
			wp_enqueue_script( 'standard-ad-300x250', get_template_directory_uri() . '/lib/standard-ad-300x250/js/admin.min.js', array( 'jquery', 'media-upload','thickbox' ), false, STANDARD_THEME_VERSION );
		} // end if
