...
function lean_ad_300x250($) {
	...
	$('.ad-300x250-wrapper > .preview_image_container').unbind('click')
		.click(function(evt) {
		...
		// Otherwise, we're running in normal mode.
			...
			lean_300x250_sAdSrcId = '#' + $('#' + sId + ' .widget-content .ad-300x250-wrapper').children('.ad_src').attr('id');
			lean_300x250_sAdSrcUrl = '#' + $('#' + sId + ' .widget-content .ad-300x250-wrapper').children('.ad_url').attr('id');
	...
	$('.ad-300x250-wrapper > .ad_delete').click(function(evt) {
