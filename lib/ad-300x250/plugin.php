...
class Ad_300x250 extends WP_Widget {
	...
	private function display_ad( $ad_src, $ad_url ) {
		...
		if( 0 == strlen( trim( $ad_src ) ) ) {
			...
			$ad_src = '<img class="img-responsive" src="' . get_template_directory_uri() . '/lib/ad-300x250/images/ad-360.jpg" alt="" />';
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Ad_300x250" );' ) );