 ...
 * @version	1.5
 */
class Lean_Influence extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_opts = array(
			'classname' 	=> __( 'lean-social-influence', 'lean' ),
			'description' 	=> __( 'Display your social influence by showcasing Twitter followers and Facebook fans.', 'lean' )
		);	
		$this->WP_Widget( 'lean-influence-widget', __( 'Social Influence', 'lean' ), $widget_opts );
	...
	public function register_admin_styles() {
		wp_enqueue_style( 'lean-influence', get_template_directory_uri() . '/lib/influence/css/admin.css' );
...
add_action( 'widgets_init', create_function( '', 'register_widget( "Lean_Influence" );' ) );